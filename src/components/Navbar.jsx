...
import { Sun, Moon, Flame, BookOpen, Layers, BarChart2, Menu, X, ShieldCheck, GraduationCap, MessageCircle, Dumbbell } from "lucide-react";
...
export default function Navbar({ username, streak, points, xp, onReset }) {
  ...
  const navLinks = [
    ...
    { to: "/practice", label: "Pratik", icon: Dumbbell, highlight: true },
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-14">
          ...
          <div className="hidden md:flex items-center gap-1">
            {navLinks.map(({ to, label, icon: Icon, accent, highlight }) => {
